...
public class LockTaskManager {
    ...
    public void updateApprovedPackages(Set<String> approved) {
        ...
        try {
            ...
            // חובה MATCH_DISABLED_COMPONENTS + MATCH_UNINSTALLED_PACKAGES
            // כדי לראות גם אפליקציות שכבר הוסתרו (setApplicationHidden)
            ...
            for (ApplicationInfo info : installed) {
                ...
                // בדוק launcher intent כולל אפליקציות מושבתות
                ...
                java.util.List<?> activities = pm.queryIntentActivities(
                        launchIntent, PackageManager.MATCH_DISABLED_COMPONENTS);
