...
public class AdminActivity extends AppCompatActivity {
    ...
    private void setupWatermark() {
        Switch sw = findViewById(R.id.switchWatermark);
        SeekBar seekAlpha = findViewById(R.id.seekWmAlpha);
        SeekBar seekSize  = findViewById(R.id.seekWmSize);
        TextView tvAlpha  = findViewById(R.id.tvWmAlpha);
        TextView tvSize   = findViewById(R.id.tvWmSize);
        Button btnTop    = findViewById(R.id.btnWmTop);
        Button btnCenter = findViewById(R.id.btnWmCenter);
        Button btnBottom = findViewById(R.id.btnWmBottom);
        Button btnLeft   = findViewById(R.id.btnWmLeft);
        Button btnRight  = findViewById(R.id.btnWmRight);

        // טען ערכים שמורים
        sw.setChecked(prefs.isWatermarkEnabled());
        seekAlpha.setProgress(prefs.getWatermarkAlpha());
        seekSize.setProgress(prefs.getWatermarkSizeDp());
        tvAlpha.setText(prefs.getWatermarkAlpha() + "%");
        tvSize.setText(prefs.getWatermarkSizeDp() + "dp");
        highlightWmGravity(prefs.getWatermarkGravity(), btnTop, btnCenter, btnBottom, btnLeft, btnRight);

        sw.setOnCheckedChangeListener((b, checked) -> prefs.setWatermarkEnabled(checked));
    ...
    private void highlightWmGravity(int g, Button top, Button center, Button bottom, Button left, Button right) {
